package com.fa.RailwayTicketBooking;
...
public class TicketBooker
{
    ...
    static Queue<Integer> waitingList = new LinkedList<Integer>();//queue of WL passengers
    static Queue<Integer> racList =  new LinkedList<Integer>();//queu of RAC passengers
    static List<Integer> bookedTicketList =  new ArrayList<Integer>();//list of bookedticket passengers
    static List<Integer> lowerBerthsPositions = new ArrayList<Integer>(Arrays.asList(1));//normally 1,2,...21
    static List<Integer> middleBerthsPositions = new ArrayList<Integer>(Arrays.asList(1));//normally 1,2,...21
    static List<Integer> upperBerthsPositions = new ArrayList<Integer>(Arrays.asList(1));//normally 1,2,...21
    static List<Integer> racPositions = new ArrayList<Integer>(Arrays.asList(1));//normally 1,2,...18
    static List<Integer> waitingListPositions = new ArrayList<Integer>(Arrays.asList(1));//normally 1,2,...10
    static Map<Integer, Passenger> passengers = new HashMap<Integer, Passenger>();//map of passenger ids to passengers
    //book ticket
